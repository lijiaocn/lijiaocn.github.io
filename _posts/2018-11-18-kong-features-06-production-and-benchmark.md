---
layout: default
title:  "API网关Kong（十）：Kong在生产环境中的部署与性能测试方法"
author: 李佶澳
...
绑定的域名为`echo.com`，pod的IP为`192.168.7.2`：
	...
	$[root@10-10-199-154 tmp] kubectl -n demo-echo get ingress -o wide
	NAME           HOSTS      ADDRESS         PORTS     AGE
	ingress-echo   echo.com   10.10.173.203   80        1h
	
	[root@10-10-199-154 tmp]# kubectl -n demo-echo get pod -o wide
	NAME                    READY     STATUS    RESTARTS   AGE       IP            NODE
