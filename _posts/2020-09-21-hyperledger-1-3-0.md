...
last_modified_at: "2020-09-22T09:40:07+0800"
categories: 项目
tags: HyperLedger
cover:
...
>1.3.0 和 1.2.0 相比有一些变化，主要是权限控制方面的。这篇文档里现在还有两个问题没解决，一是 User 用户的操作权限，而是 Admin 创建合约是 orderer 认为证书错误。2020-09-22 09:39:52
