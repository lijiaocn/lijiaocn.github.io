...
changedate: 2018/07/29 13:01:04
categories: 项目
tags: HyperLedger
...
具体的操作案例可以参考[超级账本HyperLedger的Fabric-CA的使用演示(两个组织一个Orderer三个Peer)](https://www.lijiaocn.com/%E9%A1%B9%E7%9B%AE/2018/05/04/fabric-ca-example.html)，如果文档理解起来有难度，可以参考发布在网易云课堂中的视频教程。
