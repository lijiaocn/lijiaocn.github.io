---
layout: default
title: "Protocol Buffers V3 协议语法要点记录"
author: 李佶澳
date: "2022-11-29 15:27:12 +0800"
last_modified_at: "2022-11-30 18:03:43 +0800"
categories: 编程
cover:
...
以下是 V3 版本的语法要点，源自 [Language Guide (proto3) ][5]。
...
1. key_type 不能是 float 和 bytes
2. value_type 不能是 map
3. map 不能用 repeated, optional, required 修饰
4. map 内的 key-value 顺序是不保证的
