---
layout: default
title:  "Kubernetes1.12从零开始（零）：课程介绍与官方文档汇总"
author: 李佶澳
createdate: 2018/09/03 20:43:00
changedate: 2018/11/08 22:09:57
categories: 项目
...
大概从2014年6、7月份开始，Kubernetes开始被国内的一些互联网公司关注、研究、使用，经过四年时间的发展，Kubernetes已经奠定了在容器集群管理、PaaS平台等领域的主导地位。越来越多的公司都是在围绕Kubernetes打造自己的基础平台。经过四年多的发展，关于Kubernetes的资料非常丰富了，有很多非常好的教程，可以说现在是学习Kubernetes最好的时候，面对的痛苦要比几年前少太多太多。美中不足的是，很多教程依旧是灌输式地讲述知识点，而没有传授方法。

IT技术的变化是非常快的，软件可能几个月发布一个变动比较大的版本，如果只是传授知识，而不讲述方法，那么今天掌握的知识很可能几个月后就过时了，到那时候遇到新情况，又会产生各种困惑，而且面对技术的飞速变化，始终没有参与感。

经过这几年对Kubernetes断断续续的学习使用，感觉自己可以做一点事情，更好地帮人入门，从一开始就告诉初学者可以从哪里找到答案、从哪里获得最新资讯、从哪里找到最完整、最权威的定义，从一开始就接触最权威的资料。可以大大减少对互联网上各种二手资料的依赖，节省大量的时间。

本课程没有正式的讲义，使用的资料是本站的相关文章，这些文章都是我个人在学习、工作过程中随手记录的笔记，你可以在[系列教程汇总](https://www.lijiaocn.com/tags/class.html)中找到。

工作之余，制作了一些演示视频，发布在[网易云课堂·IT技术快速入门学院 ](https://study.163.com/provider/400000000376006/course.htm?share=2&shareId=400000000376006)。制作视频是比较耗费时间和精力的，并且观看视频的效率也没有阅读效率高，因此视频力求简短精炼，聚焦于感知的建立，只用来辅助上手，缩短初学者的入门时间。

除了[文章](https://www.lijiaocn.com)和[视频](https://study.163.com/provider/400000000376006/course.htm?share=2&shareId=400000000376006)，还有一个QQ交流群`947371129`和一个名为`我的网课`的知识星球。QQ群用于这门课程的学习者以及所有对Kubernetes感兴趣的人员的互相交流，知识星球是一个知识社区，类似于早期的BBS，可以发帖、提问，相比QQ群，主题更集中，并且留有记录，容易查找，对知识星球可以通过[不贵、回报超高的，付费社区都有哪些?](https://www.lijiaocn.com/%E5%A5%BD%E8%B4%A7/2018/04/25/fu-fei-she-que.html)这篇文章进行了解。

[知识星球·我的网课](https://www.lijiaocn.com/img/xiaomiquan-class.jpeg)

除此之外，还可以关注微信公众号、加我微信，公众号二维码在网页右下角，关注后会自动回复我的个人微信。平时正常上班，会有意防止微信、QQ、企业微信等将大块的时间分割成小块，因此很少能够及时回复，并且通过QQ、微信私下交流，花费的时间一分钟都不少，但只对你、我两个人有效，沟通的价值没有最大化，这非常不好。因此建议尽量使用知识星球，知识星球早先创建的时候设置了一年的有效期，目前正在想办法解除，变更成永久有效。另外，我正在给站点添加的评论功能，也是非常好的沟通方式。
